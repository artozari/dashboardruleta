...
export class SalamapComponent implements OnChanges {
  ...
  @Input() min: number= new Date().getTime();
  canvas = new Canvas();
  objeto: any;
  ubicacion: number[];
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    if (this.objeto?.get("id") === this.datoSimple.tableData[1]) {
      ...
      this.canvas.remove(this.objeto);
      // }
      this.canvas.remove(this.objeto);
      this.mesa = new Path(this.pathString, {//#
        ...
        fill: this.datoSimple.configData[33].toString(), // Relleno negro para el fondo
        selectable: true,
      ...
      this.mesa = new Path(this.pathString, {//#
        ...
        left: parseInt(this.datoSimple.tableData[9].toString()),
        top: parseInt(this.datoSimple.tableData[11].toString()),
        fill: "green", // Relleno negro para el fondo
        selectable: true,
        id: this.datoSimple.tableData[1],
      });
      this.numero = new FabricText(/* this.datoSimple.winningNumbersData[this.datoSimple.winningNumbersData.length - 1][3].toString() */this.datoSimple.winningNumbersData[0][3].toString(),//#
        {
          strokeWidth: this.strokeWidth,
          backgroundColor: "transparent",
          stroke: "white",
      ...
      this.idMesa = new FabricText(/* this.datoSimple.winningNumbersData[this.datoSimple.winningNumbersData.length - 1][3].toString() */this.datoSimple.tableData[1].toString(),//#
        {
          strokeWidth: this.strokeWidth,
          backgroundColor: "transparent",
          stroke: "black",
